...
from gestciv.tools import tools
import string
import uuid
...
class Departement(models.Model):
        ...
        c_dep           = models.DecimalField(max_digits=4,  decimal_places=0, verbose_name="Code département")
...
class Mairie(models.Model):
	...
	code		= models.DecimalField(max_digits=4,  decimal_places=0, verbose_name="Code commune") 
...
post_save.connect(CreateGroup, sender=Mairie)

class Arrondissement(models.Model):

	c_arr		= models.DecimalField(max_digits=4,  decimal_places=0, verbose_name="Code arrondissement")
	...
	adresse		= models.CharField(max_length=60, null=True, unique=False, verbose_name='Adresse postale')
	phone		= models.CharField(max_length=15, null=True, unique=False, verbose_name='Téléphone')
	ca		= models.ForeignKey(DjangoUser, related_name='nom_ca', verbose_name='Nom & Prénom du CA',on_delete=models.PROTECT)
	#groupe		= models.ForeignKey(DjangoGroup, related_name='groupe', verbose_name='groupe', on_delete=models.CASCADE, null=False)
...
post_save.connect(CreateGroup, sender=Arrondissement)


class Quartier(models.Model):

	c_qua           = models.DecimalField(max_digits=4,  decimal_places=0, verbose_name="Code village")
	arrondissement  = models.ForeignKey(Arrondissement, related_name='quartier_arrondissement', verbose_name='arrondissement',
			on_delete=models.CASCADE, null=False)
	nom             = models.CharField(max_length=30, null=False, verbose_name='Nom quartier')
	adresse         = models.CharField(max_length=60, null=True, unique=False, verbose_name='Adresse postale')
	phone           = models.CharField(max_length=15, null=True, unique=False, verbose_name='Téléphone')
	cq		= models.ForeignKey(DjangoUser, related_name='nom_cq', null=True, verbose_name='Nom & Prénom du CQ/CV',
...
class RegistrationManager(models.Manager):
    ...
    def is_minor(self, nip):
        child = self.search(nip).filter(age > 18) 
        return child

    def is_single(self):
       if self.search(self.nip).filter(marital_status != 'M') is not None:
          return "Célibataire"
       return "Marié"
...
class Registration(ModelEntity):
	...
	ice	                    = models.ForeignKey("self", related_name='ice_registration', verbose_name='Personne à joindre', 
					on_delete=models.CASCADE, null=True, blank=True)
	marital_status              = models.CharField(max_length=15, choices=STATUS_CHOICES, default='M',verbose_name='Stuation matrimoniale')
	sex                         = models.CharField(max_length=8, choices=SEX_CHOICES, default='F', null=True, blank=True, verbose_name='Sexe')
	...
	ethnie 			    =  models.ForeignKey(GroupeEthnique, related_name='ethnie_reside', null=True, blank=True, verbose_name='Ethnie',
...
#					verbose_name='rue et numéro, quartier, hameau, village')
	...
	created_by      	    = models.ForeignKey(DjangoUser, related_name='chef_quartier', on_delete=models.CASCADE, null=True, blank=True)
...
#	birthcity       = models.CharField(max_length=30, null=False, verbose_name='Lieu de naissance')
...
#	place_of_dec	= models.ForeignKey(DjangoGroup, verbose_name="Lieu de déclaration", related_name='place_of_declaration', 
